...
TASK1_ALERT_QUEUE = [
    ...
    # -----------------------------------------------------------------------
    # C5: EXTENDED ALERT POOL — 10 new alerts for diversity
    # -----------------------------------------------------------------------
    {
        "alert_id": "ALT-040",
    ...
    },
    {
        ...
        "description": "SSL certificate expired on internal HR portal — scheduled renewal pending",
        "raw_data": {"cert_cn": "hr.internal.corp", "expiry": "2024-01-17", "auto_renew": True},
        "ground_truth_classification": "benign",
        "ground_truth_priority": "P4",
    },
    {
        ...
        "alert_type": "DNS Tunneling Suspected",
        "severity": "critical",
        "timestamp": "2024-01-18T03:22:45Z",
        "source_ip": "10.0.2.15",
        "dest_ip": "198.51.100.53", "dest_port": 53,
        "description": "High-entropy DNS queries with encoded payload to external resolver",
        "raw_data": {"query_count": 342, "avg_subdomain_len": 48, "entropy": 4.7, "domain": "x7k2.data.evil.com"},
        "ground_truth_classification": "critical",
    ...
    },
    {
        ...
        "severity": "critical",
        "timestamp": "2024-01-18T14:05:30Z",
        "source_ip": "10.0.1.55",
        "dest_ip": None, "dest_port": None,
        "description": "User added self to Domain Admins group via net.exe",
        "raw_data": {"user": "jdoe", "command": "net group 'Domain Admins' jdoe /add", "host": "WS-DEV-02"},
        "ground_truth_classification": "critical",
        "ground_truth_priority": "P1",
    },
    {
        "alert_id": "ALT-044",
        "alert_type": "Scheduled Task Created Remotely",
        "severity": "high",
        "timestamp": "2024-01-18T15:30:00Z",
        "source_ip": "10.0.1.55",
        "dest_ip": "10.0.0.30", "dest_port": 445,
        "description": "Remote scheduled task creation on database server by non-admin user",
        "raw_data": {"task_name": "SystemUpdate", "executable": "C:\\temp\\update.exe", "user": "jdoe"},
        "ground_truth_classification": "critical",
        "ground_truth_priority": "P1",
    },
    {
        "alert_id": "ALT-045",
        "alert_type": "VPN Login from New Country",
        "severity": "medium",
        "timestamp": "2024-01-18T06:00:00Z",
        "source_ip": "203.0.113.88",
        "dest_ip": "10.0.0.1", "dest_port": 443,
        "description": "VPN login from Romania for user who normally connects from US",
        "raw_data": {"user": "asmith", "country": "RO", "usual_country": "US", "mfa_passed": True},
        "ground_truth_classification": "suspicious",
        "ground_truth_priority": "P2",
    },
    {
        "alert_id": "ALT-046",
        "alert_type": "Antivirus Signature Update",
        "severity": "low",
        "timestamp": "2024-01-18T04:00:00Z",
        "source_ip": "10.0.0.100",
        "dest_ip": None, "dest_port": None,
        "description": "Routine AV signature update completed successfully on all endpoints",
        "raw_data": {"version": "2024.01.18.001", "endpoints_updated": 147, "status": "success"},
        "ground_truth_classification": "benign",
        "ground_truth_priority": "P4",
    },
    {
        "alert_id": "ALT-047",
        "alert_type": "Data Loss Prevention Alert",
        "severity": "high",
        "timestamp": "2024-01-18T16:45:00Z",
        "source_ip": "10.0.2.50",
        "dest_ip": "104.16.0.1", "dest_port": 443,
        "description": "Credit card numbers detected in outbound email attachment",
        "raw_data": {"user": "bwalker", "file": "Q4_report.xlsx", "cc_count": 23, "dest": "personal_gmail"},
        "ground_truth_classification": "critical",
        "ground_truth_priority": "P1",
    },
    {
        "alert_id": "ALT-048",
        "alert_type": "Network Scan Detected",
        "severity": "medium",
        "timestamp": "2024-01-18T12:30:00Z",
        "source_ip": "10.0.0.100",
        "dest_ip": None, "dest_port": None,
        "description": "Sequential port scan across /24 subnet from IT scanner workstation",
        "raw_data": {"scanner": "IT-SCANNER-01", "ports_scanned": 1024, "is_scheduled": True},
        "ground_truth_classification": "benign",
        "ground_truth_priority": "P4",
    },
    {
        "alert_id": "ALT-049",
        "alert_type": "Lateral Movement via SMB",
        "severity": "critical",
        "timestamp": "2024-01-18T14:15:00Z",
        "source_ip": "10.0.1.55",
        "dest_ip": "10.0.0.5", "dest_port": 445,
        "description": "Pass-the-hash attack detected targeting domain controller via SMB",
        "raw_data": {"user": "jdoe", "auth_type": "NTLM", "target": "DC-01", "tool": "mimikatz"},
        "ground_truth_classification": "critical",
        "ground_truth_priority": "P1",
    },
]
